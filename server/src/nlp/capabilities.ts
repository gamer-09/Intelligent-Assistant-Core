...
export const CAPABILITIES: Capability[] = [
  ...
  { id: "system-info", name: "System Info", description: "Reports basic, non-sensitive machine stats: OS, CPU, memory, uptime.", examples: ["System info", "How much memory do you have?"], category: "System Access" },
  { id: "system-file-browse", name: "Browse a Local Folder", description: "Lists files/folders inside one directory you explicitly approve via ASSISTANT_FS_ROOT. Read-only, and confined to that folder — off by default.", examples: ["List files in reports", "What's in my folder?"], category: "System Access" },
  { id: "system-file-read", name: "Read a Local File", description: "Reads the plain-text contents of a file inside the approved folder. Skips likely credential/key files and large binaries. Read-only, never writes or deletes.", examples: ["Read the file notes.txt", "Show me the contents of todo.md"], category: "System Access" },
];
